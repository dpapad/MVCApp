...
public class ContactDetailsServlet extends HttpServlet {
    ...
    public ContactDetailsServlet(RepositoryFactory repositoryFactory) {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        try{            
            ...
            if(request.getContextPath().equals("/contView.jsp")) {
                request.getRequestDispatcher("/contDetails.jsp").forward(request, response);
            }
            else {
                request.getRequestDispatcher("/contUpdate.jsp").forward(request, response);
            }
